...
package EnsEMBL::Web::Document::HTML::TranscriptomeOnly;
...
sub render_species_list {
  ...
  foreach (@{$hub->get_species_set('TRANSCRIPTOME_ONLY')}) {
  ...
  if (@ok_extra){
    ...
    $html = qq{<div class="lb-info-box"><h3 class="lb-heading">Transcriptome assemblies</h3><div class="lb-extra-assemblies">$extra_html</div></div>};
  }
  return $html;
}
